    ...
    activate: (app, translator) => {
        ...
        const factory = (options) => {
            return options.collaborative
                ? new WebSocketProvider(Object.assign(Object.assign({}, options), { url, user: app.serviceManager.user, translator: trans }))
                : new ProviderMock();
        };
        return factory;
    }
