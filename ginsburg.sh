...
export PYTHONPATH=$PYTHONPATH:/burg/opt/anaconda3-2022.05/lib/python3.9/site-packages:~/.conda/envs/sofe/bin/pip:/burg/urbangroup/users/msa2187/pip-packages

#Command to execute Python program
/burg/home/msa2187/.conda/envs/sofe/bin/python sputter.py
